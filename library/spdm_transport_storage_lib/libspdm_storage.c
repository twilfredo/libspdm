...
void libspdm_storage_set_secured_encap_status(
    spmd_storage_secured_message_encapsulated_status_t status)
{
 ...
 **/
spmd_storage_secured_message_encapsulated_status_t
    ...
    bool is_request_message)
{
    ...
    *secured_message_size = *transport_message_size - sec_trans_header_size;
    ...
    descriptor->status =
        is_request_message ? 0 : libspdm_storage_get_and_clear_secured_encap_status();
