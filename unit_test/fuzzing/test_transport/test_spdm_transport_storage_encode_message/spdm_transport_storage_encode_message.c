...
void libspdm_test_transport_storage_test_encode_management_cmd(void **state)
{
    libspdm_test_context_t *spdm_test_context = *state;
    storage_spdm_transport_header *hdr;
...
void libspdm_test_transport_storage_test_encode_discovery_response(void **state)
{
    libspdm_test_context_t *spdm_test_context = *state;
    ...
    if (m_libspdm_transport_storage_test_context.test_buffer_size < sizeof(spdm_storage_discovery_response_t)) {
        LIBSPDM_ASSERT(false);
    }
...
void libspdm_test_transport_storage_test_encode_pending_resp(void **state)
{
    libspdm_test_context_t *spdm_test_context = *state;
    ...
    if (m_libspdm_transport_storage_test_context.test_buffer_size < sizeof(spdm_storage_pending_info_response_t)) {
        LIBSPDM_ASSERT(false);
    }
...
void libspdm_run_test_harness(void *test_buffer, size_t test_buffer_size)
{
    ...
    libspdm_test_transport_storage_test_encode_management_cmd(&state);
    libspdm_test_transport_storage_test_encode_discovery_response(&state);
    libspdm_test_transport_storage_test_encode_pending_resp(&state);
